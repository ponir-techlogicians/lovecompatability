...
GLOBAL_STROKE_DICT = {
    'en': {
        'A': 3, 'B': 3, 'C': 1, 'D': 2, 'E': 3, 'F': 3, 'G': 3, 'H': 3,
        'I': 1, 'J': 1, 'K': 3, 'L': 1, 'M': 4, 'N': 3, 'O': 1, 'P': 2,
        'Q': 2, 'R': 3, 'S': 1, 'T': 2, 'U': 1, 'V': 2, 'W': 4, 'X': 2,
        'Y': 3, 'Z': 3
    },
    'es':{
        'A': 3, 'Á': 4,
        ...
        'S': 1,
        'T': 2,
        'U': 1, 'Ú': 2, 'Ü': 3,  # Ü typically adds diaeresis, ~1 extra stroke
        'V': 2,
        'W': 4,
        'X': 2,
        'Y': 3,
    ...
    'sv':{
        'A': 3, 'B': 3, 'C': 1, 'D': 2, 'E': 3, 'F': 2, 'G': 3, 'H': 3,
    ...
    'vi':{
        ...
        'E': 3, 'Ê': 4, 'G': 3, 'H': 3, 'I': 1, 'K': 3, 'L': 2, 'M': 4,
        'N': 3, 'O': 1, 'Ô': 2, 'Ơ': 2, 'P': 2, 'Q': 2, 'R': 3, 'S': 1,
        'T': 2, 'U': 1, 'Ư': 1, 'V': 2, 'X': 2, 'Y': 3,
        '́': 1, '̀': 1, '̉': 1, '̃': 1, '̣': 1
    },
    'he':{
...
def split_names_safe(name1: str, name2: str,lang:str=None) -> list[str]:
